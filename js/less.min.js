        ...
        function (a) {
            a.Ruleset = function (a, b, c) {
                ...
                genCSS: function (b, c) {
                    ...
                    var m, n = b.compress ? "" : Array(b.tabLevel + 1).join("  "),
                        o = b.compress ? "" : Array(b.tabLevel).join("  ");
                    for (e = 0; e < this.rules.length; e++) i = this.rules[e], d(i, this.root) ? l.push(i) : k.push(i);
                    if (!this.root) {
                        h = a.debugInfo(b, this, o), h && (c.add(h), c.add(o));
                        var p, q = this.paths,
                            r = q.length;
                        for (m = b.compress ? "," : ",\n" + o, e = 0; r > e; e++)
                            if (j = q[e], p = j.length)
                                for (e > 0 && c.add(m), b.firstSelector = !0, j[0].genCSS(b, c), b.firstSelector = !1, f = 1; p > f; f++) j[f].genCSS(b, c);
                        c.add((b.compress ? "{" : " {\n") + n)
                    }
                    for (e = 0; e < k.length; e++) i = k[e], e + 1 !== k.length || this.root && 0 !== l.length && !this.firstRoot || (b.lastRule = !0), i.genCSS ? i.genCSS(b, c) : i.value && c.add(i.value.toString()), b.lastRule ? b.lastRule = !1 : c.add(b.compress ? "" : "\n" + n);
                    if (this.root || (c.add(b.compress ? "}" : "\n" + o + "}"), b.tabLevel--), m = (b.compress ? "" : "\n") + (this.root ? n : o), g = l.length)
                        for (k.length && m && c.add(m), l[0].genCSS(b, c), e = 1; g > e; e++) m && c.add(m), l[e].genCSS(b, c);
